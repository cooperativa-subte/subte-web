function getProjects() {
  return new Promise((resolve, reject) => {
    resolve([
      ...
      { id: 5, name: 'Ades Montevideo', url: 'adesmontevideo', imgCover: 'https://res.cloudinary.com/mepediacobas/image/upload/v1574886344/subte-web/projects-covers/adesmontevideo-cover.png' }
    ])
  })
}
